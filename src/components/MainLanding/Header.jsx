        ...
        <div className="flex flex-col lg:flex-row justify-between mt-10 lg:mt-20 px-2 lg:px-10">
            <div className="w-full lg:w-6/12 flex flex-col items-center justify-center">
                ...
                <p className=" px-4 py-2 text-lg text-slate-100 font-mono r lg:text-start">
                    Независимо от вашего уровня опыта в программировании - будь то начинающий или опытный специалист, наша платформа предлагает обучение для всех. Мы стремимся создать поддерживающую и вдохновляющую среду, где вы сможете развиваться и достигать новых высот в своей карьере в области информационных технологий. Присоединяйтесь к нам, чтобы обрести уверенность в своих знаниях, научиться новым технологиям и стать успешным в мире IT.
                </p>
                <p className="px-4 py-2 text-lg text-slate-100 font-mono  lg:text-start">
