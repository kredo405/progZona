...
import { useDispatch, useSelector } from "react-redux"; // Importing both hooks from 'react-redux'
import { setShow } from "../../store/slices/verticalMenuSlice";
import {VerticalMenuState} from "../../store/slices/verticalMenuSlice";
import { RootState } from "../../store"; // Assuming RootState is the type for your root state
