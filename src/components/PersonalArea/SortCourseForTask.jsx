...
export const SortCourseForTasks = () => {
    ...
    return (
        <div className="relative max-w-xl px-4 mx-auto mt-12">
            <button
                className="flex items-center justify-between w-[60vh] px-10 py-5 text-gray-800 font-bold bg-white border rounded-md shadow-sm cursor-default outline-none focus:border-indigo-600"
                aria-haspopup="true"
                aria-expanded="true"
                onClick={() => setState(!state)}
            >
                {selectedItem.item || "Выберите курс"}
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-6 h-6 text-gray-400 ml-10"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                >
